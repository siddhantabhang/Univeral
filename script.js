document.addEventListener('DOMContentLoaded', function() {
    ...
    // Redirect on visiting specific pages
    const path = window.location.pathname;

    if (path === '/invite') {
        window.location.href = 'https://discord.com/oauth2/authorize?client_id=1102842571018993666&permissions=8&integration_type=0&scope=bot';
    } else if (path === '/support') {
        window.location.href = 'https://discord.gg/sageverse';
    }
